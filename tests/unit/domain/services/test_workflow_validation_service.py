...
class TestValidateWorkflowTemplate:
    ...
    def test_empty_template_returns_error(self):
        ...
        template = WorkflowTemplate.create(name="empty", display_name="Empty", description="Empty template")
    ...
    def test_invalid_dependency_returns_error(self):
        ...
        template = WorkflowTemplate.create(name="invalid_dep", display_name="Invalid Dependency")
    ...
    def test_circular_dependency_returns_error(self):
        ...
        template = WorkflowTemplate.create(name="circular", display_name="Circular Dependencies")
    ...
    def test_review_stage_missing_maker_returns_error(self):
        ...
        template = WorkflowTemplate.create(name="invalid_review", display_name="Invalid Review")
        template.add_stage(
            "review",
            "agent_1",
            stage_type="review",
    ...
    def test_too_many_parallel_stages_returns_error(self):
        ...
        template = WorkflowTemplate.create(name="too_many_parallel", display_name="Too Many Parallel")
    ...
    def test_duplicate_stage_names_returns_error(self):
        ...
        template = WorkflowTemplate.create(name="duplicate_names", display_name="Duplicate Names")
    ...
    def test_empty_stage_name_returns_error(self):
        ...
        template = WorkflowTemplate.create(name="empty_name", display_name="Empty Stage Name")
    ...
    def test_empty_agent_id_returns_error(self):
        ...
        template = WorkflowTemplate.create(name="empty_agent", display_name="Empty Agent ID")
    ...
    def test_multiple_errors_returned(self):
        ...
        template = WorkflowTemplate.create(name="multiple_errors", display_name="Multiple Errors")
        template.add_stage("stage1", "agent_1", dependencies=["nonexistent"])
        template.add_stage("stage2", "agent_2", dependencies=["stage1"])
        template.add_stage(
            "review",
    ...
    def test_complex_valid_workflow(self):
        ...
        template = WorkflowTemplate.create(name="complex", display_name="Complex Workflow")
        ...
        # Parallel stages
        template.add_stage("impl_frontend", "frontend_dev", dependencies=["design"], is_parallel=True)
        template.add_stage("impl_backend", "backend_dev", dependencies=["design"], is_parallel=True)
    ...
    def test_self_dependency_detected_as_circular(self):
        ...
        template = WorkflowTemplate.create(name="self_dep", display_name="Self Dependency")
    ...
    def test_indirect_circular_dependency(self):
        ...
        template = WorkflowTemplate.create(name="indirect_circular", display_name="Indirect Circular")
...
class TestHasCircularDependencies:
    ...
    def test_no_circular_dependencies(self, valid_template):
        ...
        has_circular = WorkflowValidationService._has_circular_dependencies(valid_template)
    ...
    def test_detects_simple_circular_dependency(self):
        ...
        template = WorkflowTemplate.create(name="circular", display_name="Circular")
    ...
    def test_no_circular_with_parallel_stages(self):
        ...
        template = WorkflowTemplate.create(name="parallel", display_name="Parallel Stages")
    ...
    def test_complex_circular_dependency(self):
        ...
        template = WorkflowTemplate.create(name="complex_circular", display_name="Complex Circular")
