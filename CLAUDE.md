...
└── src/codetoreum/
    ...
    │   ├── models/             # 67 domain model classes
    ...
    │   └── testing/            # 53 mock/in-memory adapters for simulation
...
- 53 total mock and in-memory adapters for deterministic testing
...
- 53 total adapters (mock + in-memory implementations)
