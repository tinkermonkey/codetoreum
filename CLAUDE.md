...
**Ports** — input + output interfaces in `ports/`. Output ports include: ITicketSystem, ICodingAgent, IContainer, IVersionControlService, IEventStore, IBoardService, ICodeReviewService, IDiscussionAdapter, IWorkItemService, IEventEmitter, IIdentityService, IPromptBuilder, IDistributedLock. (See `documentation/architecture/ports/README.md` for the full catalogue.)
