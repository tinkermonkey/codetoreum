...
class QueueEntry:
    ...
    Attributes: work_item_id: ID of work item in queue
...
class LockAcquisitionResult:
    ...
    Attributes: status: ACQUIRED, QUEUED, or ALREADY_HELD
...
class LockReleaseResult:
    ...
    Attributes: released_work_item_id: ID of work item that held lock
...
class PipelineQueueState:
    ...
    Attributes: board_id: Board containing pipeline
...
class IQueuedPipelineLockService(ABC):
    ...
    async def try_acquire_lock(
        ...
        Returns: LockAcquisitionResult with status and queue information
    ...
    async def release_lock(self, project_id: str, board_id: str, work_item_id: str) -> LockReleaseResult:
        ...
        Returns: LockReleaseResult with next work item and queue length

        Raises: ValueError: Invalid parameters or not lock holder
        """
    ...
    async def get_queue_state(self, project_id: str, board_id: str) -> PipelineQueueState:
        ...
        Returns: PipelineQueueState with lock holder, acquisition time, and queue
        """
