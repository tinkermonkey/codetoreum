...
class AuthDependencies:
    ...
    def require_permission(self, permission: Permission) -> Callable[[AuthContext], Awaitable[AuthContext]]:
    ...
    def require_any_permission(self, *permissions: Permission) -> Callable[[AuthContext], Awaitable[AuthContext]]:
    ...
    def require_all_permissions(self, *permissions: Permission) -> Callable[[AuthContext], Awaitable[AuthContext]]:
