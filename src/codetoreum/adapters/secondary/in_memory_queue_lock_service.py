        ...
        with self._lock:
            ...
            if state.lock_holder is None:
                ...
                if self._event_bus:
                    ...
                    try:
                        ...
                        logger.error(
                            f"CRITICAL: Failed to publish lock acquired event for "
                            f"work_item={work_item_id}, project={project_id}, board={board_id}. "
                            f"Lock was acquired but event was lost.",
                            exc_info=True,
                            extra={
                                "work_item_id": work_item_id,
                                "project_id": project_id,
            ...
            if self._event_bus:
                ...
                try:
                    ...
                    logger.error(
                        f"CRITICAL: Failed to publish work item queued event for "
                        f"work_item={work_item_id}, project={project_id}, board={board_id}. "
                        f"Work item was queued but event was lost.",
                        exc_info=True,
                        extra={
                            "work_item_id": work_item_id,
                            "project_id": project_id,
        ...
        with self._lock:
            ...
            if self._event_bus:
                ...
                try:
                    ...
                    logger.error(
                        f"CRITICAL: Failed to publish lock released event for "
                        f"work_item={work_item_id}, project={project_id}, board={board_id}. "
                        f"Lock was released but event was lost.",
                        exc_info=True,
                        extra={
                            "work_item_id": work_item_id,
                            "project_id": project_id,
                ...
                if next_item_id:
                    ...
                    try:
                        ...
                        logger.error(
                            f"CRITICAL: Failed to publish lock acquired event for next item "
                            f"work_item={next_item_id}, project={project_id}, board={board_id}. "
                            f"Lock was acquired but event was lost.",
                            exc_info=True,
                            extra={
                                "work_item_id": next_item_id,
