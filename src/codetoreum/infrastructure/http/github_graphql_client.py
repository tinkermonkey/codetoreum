    ...
    async def execute(
        ...
        try:
            ...
            if response.status_code >= 400:
                raise ExternalServiceError("GitHub", f"GitHub GraphQL API error: {response.status_code}")
            ...
            if data.get("errors"):
                ...
                raise ExternalServiceError("GitHub", f"GraphQL errors: {'; '.join(error_messages)}")
