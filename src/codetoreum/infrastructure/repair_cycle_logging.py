...
class RepairCycleLogger:
    ...
    def error(self, message: str, data: Optional[Dict[str, Any]] = None, exc_info: bool = False) -> None:
        """Log error message."""
        self.logger.error(self._format_message(message, data), exc_info=exc_info, extra={"error_id": ErrorRegistry.ErrorRegistry.ERR_REPAIR_CYCLE_ERROR})
...
class RepairCycleErrorLogger:
    ...
    def log_test_failure(
        ...
        self.logger.error(msg, extra={"error_id": ErrorRegistry.ErrorRegistry.ERR_REPAIR_CYCLE_ERROR})
